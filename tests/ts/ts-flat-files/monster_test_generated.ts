...
export function unionToAny(
  ...
  switch (MyGame_Example_Any[type]) {
    case 'NONE':
      return null;
    case 'Monster':
      return accessor(new MyGame_Example_Monster())! as MyGame_Example_Monster;
    case 'TestSimpleTableWithEnum':
      return accessor(new MyGame_Example_TestSimpleTableWithEnum())! as MyGame_Example_TestSimpleTableWithEnum;
    case 'MyGame_Example2_Monster':
      return accessor(new MyGame_Example2_Monster())! as MyGame_Example2_Monster;
    default:
      return null;
  }
}
...
export function unionListToAny(
  ...
  switch (MyGame_Example_Any[type]) {
    case 'NONE':
      return null;
    case 'Monster':
      return accessor(index, new MyGame_Example_Monster())! as MyGame_Example_Monster;
    case 'TestSimpleTableWithEnum':
      return accessor(index, new MyGame_Example_TestSimpleTableWithEnum())! as MyGame_Example_TestSimpleTableWithEnum;
    case 'MyGame_Example2_Monster':
      return accessor(index, new MyGame_Example2_Monster())! as MyGame_Example2_Monster;
    default:
      return null;
  }
}
