...
} from '../../my-game/example2/monster.js';
...
export function unionToAnyUniqueAliases(
  ...
  switch (AnyUniqueAliases[type]) {
    ...
    case 'TS':
      return accessor(new TestSimpleTableWithEnum())! as TestSimpleTableWithEnum;
    case 'M2':
...
export function unionListToAnyUniqueAliases(
  ...
  switch (AnyUniqueAliases[type]) {
    ...
    case 'TS':
      return accessor(index, new TestSimpleTableWithEnum())! as TestSimpleTableWithEnum;
    case 'M2':
